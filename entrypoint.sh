...
export TALOS_HTTP_HOST="${TALOS_HTTP_HOST:-0.0.0.0}"
export TALOS_METRICS_HOST="${TALOS_METRICS_HOST:-0.0.0.0}"
export TALOS_METRICS_PORT="${TALOS_METRICS_PORT:-4422}"
export TALOS_API_KEYS_PREFIX_CURRENT="${TALOS_API_KEYS_PREFIX_CURRENT:-talos}"
export TALOS_API_KEYS_DEFAULT_TTL="${TALOS_API_KEYS_DEFAULT_TTL:-2160h}"
export TALOS_API_KEYS_MAX_TTL="${TALOS_API_KEYS_MAX_TTL:-8760h}"
export TALOS_DERIVED_TOKENS_DEFAULT_TTL="${TALOS_DERIVED_TOKENS_DEFAULT_TTL:-1h}"
export TALOS_MACAROON_PREFIX_CURRENT="${TALOS_MACAROON_PREFIX_CURRENT:-talos}"
